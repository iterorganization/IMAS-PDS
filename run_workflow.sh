...
# ---- module environment ---------------------------------------
[[ -n "${PDS_REPO:-}" ]] || error "PDS module not loaded. Run 'module use /home/ITER/dejongy/projects/modules/all && module load PDS' first (see setup_files/easyconfigs/p/PDS/)."
[[ "$PDS_REPO" == "$PWD" ]] || error "PDS_REPO ($PDS_REPO) does not match \$PWD ($PWD). Run 'module use /home/ITER/dejongy/projects/modules/all && module load PDS' from this checkout's root."
