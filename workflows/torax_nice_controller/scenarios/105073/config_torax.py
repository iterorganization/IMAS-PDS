...
import imas
imas_uri = "imas:hdf5?path=/home/ITER/sanderm/gitrepos/pds/workflows/torax_nice_controller/scenarios/105073/tmp/data/105073_in/"
...
# dbe = imas.DBEntry(imas_uri, 'r')
# cs_ids = dbe.get('core_sources')
# sources = sources_from_IMAS(cs_ids, t_initial)['ecrh']
# ecrh = sources['ecrh']
