...
def main():
    ...
    equilibrium_plots_dina_metis_1(args, dbs)
    equilibrium_plots_dina_metis_2(args, dbs)

    for db in dbs.values():
        db.close()


def equilibrium_plots_dina_metis_1(args, dbs):
    """Plot equilibrium IDS output data for dina-metis"""
...
def equilibrium_plots_dina_metis_2(args, dbs):
    """Plot equilibrium IDS output data for dina+metis"""
